...
están en el archivo **libros_ejemplo.json**

Sólo tiene que copiar el contenido del archivo en la terminal del cliente de
Mongo.

Pongamos aquí el contenido para que pueda pegarle una miradita sin necesidad

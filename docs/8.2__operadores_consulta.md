...
Estos métodos pueden combinarse libremente y son fundamentales para implementar paginación y listados ordenados.
...
Estos métodos pueden combinarse libremente y el orden en el que se escriben no afecta al resultado final.

Ejemplo: Obtener el segundo y tercer libro más caro.

Para ello ordenamos por precio de forma descendente, saltamos uno y limitamos a 2. No importa el orden como colocar skip, límite y sort.
